...
extern void Timer8IntHandler(void);

extern void SwitchPressed(void);
...
void (* const g_pfnVectors[])(void) =
{
    ...
    Timer6IntHandler,                      // Wide Timer 0 subtimer A
    IntDefaultHandler,                      // Wide Timer 0 subtimer B
    Timer7IntHandler,                      // Wide Timer 1 subtimer A
    IntDefaultHandler,                      // Wide Timer 1 subtimer B
    Timer8IntHandler,                      // Wide Timer 2 subtimer A
